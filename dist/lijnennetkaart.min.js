...
var Points = function () {
    ...
    Points.prototype.drawOrigins = function drawOrigins(filter) {
        ...
        self._map.addLayer({
            ...
            "filter": ['all', ["==", "function", "herkomst"], ["in", "state", "origin", "destination"]]
        });
...
var Map = function () {
    ...
    Map.prototype._selectOrigin = function _selectOrigin(originId, filename) {
        ...
        // let originsSelectedFilter = ["==", "id", originId];
        // originsFilter.push(originsSelectedFilter);

        // self._map.setFilter('origins',originsFilter);
        // self._map.setFilter('origin-labels',originsFilter);
        // self._map.setFilter('origin-labels-connector',originsFilter);
    ...
    Map.prototype._initRoute = function _initRoute(destination) {
        ...
        self.session.data.originData.forEach(function (traject) {
            if (traject.properties.routeId.split('_')[1] === destination) {
        ...
        // routeId without oldor new

        // hebben die lagen wel een eigen id nodig want je verandert gewoon setData op de source
        ...
        routes.forEach(function (route) {
            ...
            route.forEach(function (traject) {
                ...
                if (traject.geometry.type === 'LineString') {
                    ...
                    var segmentContent = '<span>' + traject.properties.transport_type + '</span> <span>' + nrs + '</span><span> : </span><span>' + traject.properties.start_naam + '</span><span> - </span></span><span>' + traject.properties.end_naam + '</span>';
