    ...
    Lines.prototype.draw = function draw() {
        ...
        self._map.addLayer({
            ...
            "layout": (_layout = {
                ...
                "icon-allow-overlap": true
            }, _defineProperty(_layout, "icon-padding", 20), _defineProperty(_layout, "icon-anchor", "right"), _defineProperty(_layout, "text-field", "{trajectNaam}"), _defineProperty(_layout, "text-size", 20), _defineProperty(_layout, "text-offset", [0, 0]), _defineProperty(_layout, "text-anchor", "center"), _layout),
            'paint': {
...
var Map = function () {
    ...
    Map.prototype._setRouteInfo = function _setRouteInfo(isNew, traject) {
        ...
        routes.forEach(function (f) {
            ...
            li = document.createElement('li');
            li.innerHTML = '<div class="title">' + f.properties.transport_type + ' ' + f.properties.transport_nrs + '</div> <div class="start">' + f.properties.start_naam + '</div><div class="end">' + f.properties.end_naam + '</div><div class="time">' + f.properties.reistijd;
            ul.appendChild(li);
        });
