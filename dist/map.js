...
var Points = function () {
    ...
    Points.prototype.drawTransfers = function drawTransfers(routeId) {
...
var Map = function () {
        ...
        traject.forEach(function (r) {
            ...
            r.features.forEach(function (f) {
                ...
                if (f.geometry.type === 'LineString') {
                    ...
                    var segmentContent = '<span>' + f.properties.transport_type + '</span> <span>' + nrs + '</span><span> : </span><span>' + f.properties.start_naam + '</span><span> - </span></span><span>' + f.properties.end_naam + '</span>';
    ...
    Map.prototype._showNew = function _showNew(routeId) {
