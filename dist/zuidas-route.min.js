    ...
    Lines.prototype.draw = function draw() {
        ...
        self._map.addLayer({
            ...
            "layout": (_layout = {
                ...
                "icon-allow-overlap": true
            }, _defineProperty(_layout, "icon-padding", 20), _defineProperty(_layout, "icon-anchor", "right"), _defineProperty(_layout, "text-field", "{trajectNaam}"), _defineProperty(_layout, "text-font", ["Avenir LT Std 85 Heavy"]), _defineProperty(_layout, "text-size", 20), _defineProperty(_layout, "text-offset", [0, 0]), _defineProperty(_layout, "text-anchor", "center"), _layout),
            'paint': {
                "text-color": "#fff"
            },
